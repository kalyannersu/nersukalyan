...
const Skills = () => {
    const skillCategories = [
        ...
        { key: 'backend', title: 'Backend', icon: '⚙️', data: skills.backend },
        { key: 'database', title: 'Database', icon: '🗄️', data: skills.database },
        { key: 'tools', title: 'Tools & DevOps', icon: '🔧', data: skills.tools },
    ];
                                    ...
                                    <div key={skill.name} className="skills__item">
                                        <div className="skills__item-icon">
                                            {techIcons[skill.name] || (
                                                <span className="skills__item-letter">
                                                    {skill.name.charAt(0)}
                                                </span>
                                            )}
                                        </div>
